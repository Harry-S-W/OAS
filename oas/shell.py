        ...
        if cmd == "open":
            try:
                ...
                if subcmd == "project":
                    ...
                    if len(parts) < 3:
                        print("[OAS ERROR] Missing Arguments. Ensure you specific a path\nuse <open project 'path'>")
                        return
                ...
                if subcmd == "participant":
                    if len(parts) < 3:
                        print("[OAS ERROR] Missing Arguments. Ensure you specific a participant ID\nuse <open participant 'ID'>")
                        return
                ...
                if subcmd == "trial":
                    if len(parts) < 3:
                        print(
                            "[OAS ERROR] Missing Arguments. Ensure you specific a trial ID\nuse <open trial 'ID'>")
                        return
                ...
                print("[OAS ERROR] Missing arguments. Use: open <project> or <participant> or <trial>")
            except RuntimeError as e:
                print(f"[OAS ERROR] {e}")
            ...
            try:
                ...
                if subcmd == "project":
                    ...
                    if len(parts) < 4:
                        print("[OAS ERROR] Usage: add project <path> <name>")
                        return
                    ...
                    if len(parts) < 3:
                        print("[OAS ERROR] Usage: add <participant ID>")
                        return
                    ...
                    if len(parts) < 3:
                        print("[OAS ERROR] Usage: add <trial ID>")
                        return
                    ...
                    # now we create the participant folder
                    from oas.SystemManager.trial.trial_creation import TrialCreation
                    try:
                    ...
                    print("[OAS ERROR] Unknown add command")
                    return


            except IndexError:
                print("[OAS ERROR] Missing arguments. Use: add <project> or <participant> or <trial>")
            except RuntimeError as e:
                print(f"[OAS ERROR] {e}")
            except Exception as e:
                print(f"[OAS INTERNAL ERROR] {e}")
            ...
            try:
                ...
                print("[OAS ERROR] Missing arguments. Use: delete <project> or <participant> or <trial>")
            except RuntimeError as e:
                print(f"[OAS ERROR] {e}")
            except Exception as e:
                print(f"[OAS INTERNAL ERROR] {e}")
            ...
            try:
                ...
                if subcmd == "reset":
                    ...
                    print("[OAS ERROR] Unknown <session> command. Use <session help> for help")
            ...
            print("[OAS ERROR] Unknown command. Type <h> or <help> for help")
